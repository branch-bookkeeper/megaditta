        ...
        <div className="row section-head">
            <div className="twelve columns">
                ...
                <p>
                    ...
                    Grab the super slim code from your MailChimp account and drop the code here.
                    Lastly, remove the link and style tags that comes with the embedded code and your good to go.
                ...
                <div id="mc_embed_signup">
                    ...
                    >
                        ...
                        <div style={{ position: 'absolute', left: '-5000px' }}>
                            <input type="text" name="b_cdb7b577e41181934ed6a6a44_e65110b38d" />
                        </div>
                        <div className="clear">
                            <input
                                type="submit"
